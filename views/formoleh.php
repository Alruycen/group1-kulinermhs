<form class="d-flex" action="index.php" method="get">
    <input type="hidden" name="page" value="oleholeh">
    <span class="input-group-text" id="basic-addon1"><i data-feather="search"></i></span>
    <input class="form-control me-2" type="text" list="livesearch" name="search" placeholder="Makanan khas Tangerang" aria-label="Search" aria-describedby="basic-addon1" onkeyup="showHint(this.value)">
