...
--
-- Host: localhost:3306
-- Generation Time: May 12, 2022 at 02:24 AM
...
(1, 'Sate Bandeng', 'Daging yang diolah dari ikan bandeng dan dililit pada tusukan sate, makanan asli Tangerang.', '2022-04-27', 'Richard', 'sate-bandeng.jpg', 1),
(2, 'Bir Pletok', 'Minuman penyegar yang dicampur dari jahe, daun pandan, serai, dan kayu secang, minuman asli Tangerang.', '2022-04-28', 'Richard', 'bir-pletok.jpg', 2),
(3, 'Pasar Malam', 'Tempat yang dibuka saat malam hari di distrik hiburan yang juga menjual banyak makanan dan minuman', '2022-05-01', 'Faustine', 'pasar-malam.jpg', 3),
(4, 'Kafe', 'Tempat yang menyajikan kopi diselingi makanan ringan, tempat untuk nongkrong yang sangat nyaman.', '2022-05-02', 'Faustine', 'kafe.jpg', 3),
(5, 'Restoran', 'Tempat untuk makan bersama yang menyajikan masakan dari budaya yang berbeda di seluruh dunia.', '2022-05-02', 'Faustine', 'restoran.jpg', 3),
(6, 'Bolu Tape', 'Berbentuk kue yang lembut, manis, dan mempunyai cita rasa unik tape dari olahan singkong.', '2022-05-03', 'Wong', 'bolu-tape.jpg', 4);
...
(12, 5, 'Mantap, murah lagi', '2022-05-07', 'Wong Richard', 2),
(13, 5, 'Menu enak dan tempatnya bagus banget buat selfie.', '2022-05-07', 'Faustine Wong', 4);
...
INSERT INTO `rentangharga` (`id`, `merek`, `lokasi`, `hargaminimal`, `hargamaksimal`, `foto`, `id_artikel`) VALUES
(1, 'Sate Bandeng Hj. Maryam', 'No. 63 Kaujon Tengah, Jl. Ki Uju, Serang, Kec. Serang, Kota Serang, Banten 42116', 30000, 50000, NULL, 1),
(2, 'SABAJO Sate Bandeng', 'Jl Raya Mauk Km 16 Buaranjati Rt 04/04, Jatiwaringin, Kec. Sukadiri, Kabupaten Tangerang, Banten 15540', 25000, 30000, NULL, 1),
(3, 'MPOK NINI Bir Pletok', 'Jln Belanak 2 Ujung RT.02/01 No.57 Perumnas 2 Kel, RT.001/RW.001, Kayuringin Jaya, Kec. Bekasi Sel., Kota Bks, Jawa Barat 17144', 10000, 15000, NULL, 2),
(4, 'Sans Cafe & Vappening', 'QJ89+HQV, Kelapa Dua, Tangerang Regency, Banten 15810', 15000, 145000, NULL, 4),
(5, 'Pasar Lama Tangerang', 'Pasar Lama, Jl. Kisamaun, Sukasari, Tangerang, Tangerang City, Banten 15118', 2000, 20000, NULL, 3),
(6, 'HOG WILD with Chef Bruno Serpong', 'Ruko South Goldfinch SGA 039 The Springs, Cihuni, Pagedangan, Tangerang Regency, Banten 15332', 65000, 590000, NULL, 5),
(7, 'MAMA BOLU Bolu Tape Benteng', 'Jl. Raya Merdeka No.2, RT.002/RW.003, Sukajadi, Kec. Karawaci, Kota Tangerang, Banten 15113', 45000, 50000, NULL, 6);
...
(9, 'Richard', '$2y$10$daXuI60LobZk9zk7Iox7YemtqtzeyQxvCKJi4V5XPZy7xY2D4uHxG', 'admin', 'richard.jpg');
