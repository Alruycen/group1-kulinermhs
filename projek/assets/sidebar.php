    ...
    if(isset($_GET['page'])) {
        switch($_GET['page']) {
            case "makanan": 
                ...
                <?php while($data = $stmtdiminati->fetch(PDO::FETCH_ASSOC)): 
                    if(file_exists($data['foto'])) {
                        $foto = $data['foto'];
                    }else {
                        $foto = '../images/placeholder.png';
        ...
        <?php
            ...
            case "minuman": 
                ...
                <?php endwhile; ?>
                    ...
                    <ul>
                        <li><a class ="card-link" href="../views/menu.php?page=tempat">Cek di tempat kafe</a></li>
                    </ul>
                </div>
            </div>
            <?php
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul>
                        <li><a class ="card-link" href="../views/menu.php?page=oleholeh">Cek juga oleh-oleh khas</a></li>
                        <li><a class ="card-link" href="../views/menu.php?page=tempat">Cek juga tempat nongkrong</a></li>
                    </ul>
                </div>
            </div>
            <?php
