<div class="modal fade" id="registerForm" tabindex="-1" role="dialog" aria-labelledby="registerlabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="process/proses_tentangkami.php" class="row g-3 needs-validation">
                <div class="modal-body mx-3">
                    ...
                    <div class="form-control mb-4">
                        <input type="password" id="registerForm-pass" class="form-control validate" name="upass" required>
