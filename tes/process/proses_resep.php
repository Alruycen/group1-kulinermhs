<?php
    ...
    try {
        ...
        if(isset($_POST['submit-search'])) {
            $search = $_POST['search'];
            $sql = "SELECT * FROM artikel a, resep b WHERE a.id = b.id_artikel AND (a.nama LIKE ? OR a.deskripsi LIKE ? OR a.penulis LIKE ?)";
            ...
            if (isset($_GET['kategori'])) {
                ...
                switch($kategori) {
                    case "makanan":
                        ...
                        break;
                    case "minuman":
                        $sql = "SELECT * FROM artikel a, resep b WHERE a.id = b.id_artikel AND a.id_kategori = 2";
